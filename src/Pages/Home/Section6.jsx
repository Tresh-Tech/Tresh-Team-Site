...
const Section6 = () => {
  return (
    <div className="flex flex-col justify-center items-center py-12 gap-[30px]">
      ...
      <Accordion
        className="max-w-[810px] flex flex-col gap-[30px] w-full"
        type="single"
        collapsible
      >
        <AccordionItem value="item-1" className="border-none">
          <AccordionTrigger className="text-[24px] leading-[30px] font-normal text-[#3A3A3A]">
            What industries do you specialize in?
          </AccordionTrigger>
          <AccordionContent className="text-lg font-normal text-[#3A3A3A]">

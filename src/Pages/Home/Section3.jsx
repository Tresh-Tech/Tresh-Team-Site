  ...
  return (
    <>
      <div>
        ...
        <div className=" flex justify-center relative w-full border border-black items-center">
          <div className="flex relative flex-col items-start mb-6 p-0 gap-10">
            <div className="max-w-[140px] w-full absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <img
                className=""
                width="100%"
                height="auto"
            ...
            <div className="flex z-50 gap-10 items-start">
              <div className=" max-w-[500px] h-[234px] rounded-lg overflow-hidden flex items-center order-2 bg-white flex-grow-0 border border-[#555555]/30 w-full">
              ...
              <div className=" max-w-[500px] h-[234px] rounded-lg overflow-hidden flex items-center order-2 bg-primary flex-grow-0 border border-[#555555]/30 w-full">
